...
impl CiucAI{
    ...
    pub(crate) fn charge_cell_with_sunray(&self, planet_state: &mut PlanetState, sunray:Sunray) -> Result<(), String>
    {
    ...
    pub(crate) fn generate_carbon(&self, planet_state:&mut PlanetState, generator: &Generator) -> Result<common_game::components::resource::Carbon, String>
    {
        match &self.state() {
            AIState::SafeState => {
